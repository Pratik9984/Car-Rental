...
// Global reusable presentation viewport layer for asset mapping 
const HeroVideo = () => (
  <motion.div
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f] font-sans overflow-x-hidden">
      ...
      {/* --- HERO SECTION (Reduced container spacing bounds from pt-6 to pt-1) --- */}
      <section className="px-6 md:px-10 pt-1 md:pt-8 pb-12 md:pb-20 max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 items-center">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-4 md:space-y-6 text-left order-2 md:order-1">
          ...
          {/* --- MOBILE VIEWPORT VIDEO REORDER PLACEMENT --- */}
        ...
        {/* --- DESKTOP VIEWPORT VIDEO PLACEMENT (Hidden on mobile via hidden md:flex) --- */}
        <div className="hidden md:flex justify-center items-center w-full max-w-xl mx-auto md:max-w-none order-1 md:order-2 mt-4 md:mt-0 px-2 sm:px-0">
          <HeroVideo />
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="space-y-3">
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.01)] hover:shadow-md transition">
                ...
                <p className="text-gray-455 text-[11px] mt-1 leading-relaxed">Shivajinagar, Pune, MH 411016 <br />Open Daily: 9:00 AM — 9:00 PM</p>
              </div>
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.01)] hover:shadow-md transition">
                ...
                <p className="text-gray-455 text-[11px] mt-1 leading-relaxed">Lohegaon, Pune, MH 411032 <br />24/7 Flight Valet & Drop-Off</p>
              </div>
            </div>
          </div>
